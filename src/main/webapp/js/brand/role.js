...
var vm = new Vue({
    ...
    methods: {
        ...
        getRole: function (roleId) {
            Ajax.request({
                url: "../brand/sys/role/info/" + roleId,
                async: true,
        ...
        saveOrUpdate: function (event) {
            ...
            var url = vm.role.roleId == null ? "../brand/sys/role/save" : "../brand/sys/role/update";
            Ajax.request({
                url: url,

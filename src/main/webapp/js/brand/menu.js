...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../brand/sys/menu/queryAll', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        update: function (event) {
            ...
            Ajax.request({
                url: "../brand/sys/menu/info/" + menuId[0].id,
                async: true,
                successCallback: function (r) {
                    vm.showList = false;
                    vm.title = "修改";
        ...
        saveOrUpdate: function (event) {
            var url = vm.menu.menuId == null ? "../brand/sys/menu/save" : "../brand/sys/menu/update";
            Ajax.request({
                url: url,

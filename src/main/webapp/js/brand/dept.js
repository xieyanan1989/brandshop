...
function getGrid() {
    ...
    var table = new TreeTable(TreeGrid.id, '../brand/sys/dept/list', colunms);
...
var vm = new Vue({
    ...
    methods: {
        ...
        update: function () {
            ...
            Ajax.request({
                url: "../brand/sys/dept/info/" + deptId,
                async: true,
                successCallback: function (r) {
                    vm.showList = false;
                    vm.title = "修改";
        ...
        saveOrUpdate: function (event) {
            var url = vm.dept.deptId == null ? "../brand/sys/dept/save" : "../brand/sys/dept/update";
            Ajax.request({
                url: url,

$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {
                label: '创建时间', name: 'registerTime', index: "register_time", width: 80, formatter: function (value) {
...
//            ],
    ...
    methods: {
        ...
        update: function () {
            ...
            Ajax.request({
                url: "../brand/sys/user/info/" + userId,
                async: true,
                successCallback: function (r) {
                    vm.user = r.user;
                    //获取角色信息
        ...
        saveOrUpdate: function (event) {
            var url = vm.user.userId == null ? "../brand/sys/user/save" : "../brand/sys/user/update";
            Ajax.request({
                url: url,

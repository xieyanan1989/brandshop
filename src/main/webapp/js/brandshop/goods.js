...
//            vm.getAttributeCategories();
        ...
        getGoodsGallery: function (id) {//获取商品顶部轮播图
            Ajax.request({
                url: "../brand/goodsgallery/queryAll?goodsId=" + id,
                async: true,
                successCallback: function (r) {
        ...
        getAttributeCategories: function () {
            Ajax.request({
                url: "../brand/attributecategory/queryAll",
                async: true,
                successCallback: function (r) {
        ...
        openSpe: function () {
            ...
            openWindow({
                type: 2,
                title: '商品规格',
                content: '../brandshop/goodsspecification.html?goodsId=' + id
            })
        },
        openPro: function () {
            var id = getSelectedRow("#jqGrid");
            ...
            openWindow({
                type: 2,
                title: '产品设置',
                content: '../brandshop/product.html?goodsId=' + id
            });
        },
        unSale: function () {
            var id = getSelectedRow("#jqGrid");

...
let vm = new Vue({
    ...
    methods: {
        ...
        changeGoods: function (opt) {
            ...
            Ajax.request({
                ...
                successCallback: function (r) {
                    ...
                    Ajax.request({
                        url: "../brand/goodsspecification/queryAll?goodsId=" + goodsId + "&specificationId=1",
                        async: true,
                        successCallback: function (r) {
                            vm.colors = r.list;
                        }
                    ...
                    Ajax.request({
                        url: "../brand/goodsspecification/queryAll?goodsId=" + goodsId + "&specificationId=2",
                        async: true,
                        successCallback: function (r) {
                            vm.guiges = r.list;
                        }
                    ...
                    Ajax.request({
                        url: "../brand/goodsspecification/queryAll?goodsId=" + goodsId + "&specificationId=4",
                        async: true,
                        successCallback: function (r) {
                            vm.weights = r.list;
                        }
        ...
        saveOrUpdate: function (event) {
            let url = vm.product.id == null ? "../brand/product/save" : "../brand/product/update";

...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.userCoupon.id == null ? "../brand/usercoupon/save" : "../brand/usercoupon/update";

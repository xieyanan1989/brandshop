$(function () {
    $("#jqGrid").Grid({
        url: '../brand/coupon/list',
        colModel: [
            {label: 'id', name: 'id', index: 'id', key: true, hidden: true},
            {label: '优惠券名称', name: 'name', index: 'name', width: 120},
            {label: 'brandId', name: 'brandId', index: 'brand_id', hidden: true},
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.coupon.id == null ? "../brand/coupon/save" : "../brand/coupon/update";

$(function () {
    ...
    let url = '../brand/goodsspecification/list';
    if (goodsId) {
        url += '?goodsId=' + goodsId;
    }
    $("#jqGrid").Grid({
...
var vm = new Vue({
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            var url = vm.goodsSpecification.id == null ? "../brand/goodsspecification/save" : "../brand/goodsspecification/update";
        ...
        del: function (event) {
            ...
            confirm('确定要删除选中的记录？', function () {
                Ajax.request({
                    type: "POST",
                    url: "../brand/goodsspecification/delete",
                    contentType: "application/json",
        ...
        getInfo: function (id) {
            Ajax.request({
                url: "../brand/goodsspecification/info/" + id,
                async: true,
                successCallback: function (r) {

...
public class DataFilterAspect {
    ...
    private BrandSysRoleDeptService brandSysRoleDeptService;
    /**
     * 切点
     */
    ...
    private Object getFilterSQLBrand(BrandUserEntity user, JoinPoint point) {
           ...
           if (StringUtils.isNotEmpty(deptAlias) || StringUtils.isNotBlank(userAlias)) {
               if (StringUtils.isNotEmpty(deptAlias)) {
                   //取出登录用户部门权限
                   String alias = getAliasByUserBrand(user.getUserId());
	...
	private String getAliasByUserBrand(Long userId) {
		  @SuppressWarnings("unchecked")
	        List<Long> roleOrglist = brandSysRoleDeptService.queryDeptIdListByUserId(userId);

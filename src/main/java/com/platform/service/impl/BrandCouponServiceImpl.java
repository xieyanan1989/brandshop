...
import com.platform.dao.BrandCouponDao;
import com.platform.dao.BrandCouponGoodsDao;
import com.platform.dao.BrandUserCouponDao;
...
import com.platform.service.BrandCouponService;
 ...
 */
@Service("brandCouponService")
public class BrandCouponServiceImpl implements BrandCouponService {
    @Autowired
    private BrandCouponDao couponDao;
    @Autowired
    private BrandUserCouponDao userCouponDao;
    @Autowired
    private BrandCouponGoodsDao couponGoodsDao;
    @Autowired

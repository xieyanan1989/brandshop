...
import com.platform.service.BrandUserCouponService;
 ...
 */
@Service("brandUserCouponService")
public class BrandUserCouponServiceImpl implements BrandUserCouponService {
    @Autowired

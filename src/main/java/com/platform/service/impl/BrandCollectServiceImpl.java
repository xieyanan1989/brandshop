...
import com.platform.dao.BrandCollectDao;
import com.platform.entity.CollectEntity;
import com.platform.service.BrandCollectService;


@Service("brandCollectService")
public class BrandCollectServiceImpl implements BrandCollectService {
	@Autowired
	private BrandCollectDao collectDao;

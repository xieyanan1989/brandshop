...
import com.platform.dao.BrandAttributeCategoryDao;
import com.platform.entity.AttributeCategoryEntity;
import com.platform.service.BrandAttributeCategoryService;
 ...
 */
@Service("brandAttributeCategoryService")
public class BrandAttributeCategoryServiceImpl implements BrandAttributeCategoryService {
    @Autowired
    private BrandAttributeCategoryDao attributeCategoryDao;

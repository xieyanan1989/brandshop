 ...
 */
public interface BrandSysDeptService {

    BrandSysDeptEntity queryObject(Long deptId);

    List<BrandSysDeptEntity> queryList(Map<String, Object> map);

    void save(BrandSysDeptEntity sysDept);

    void update(BrandSysDeptEntity sysDept);

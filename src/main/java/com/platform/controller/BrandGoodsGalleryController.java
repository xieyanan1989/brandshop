...
import com.platform.service.BrandGoodsGalleryService;
 ...
 */
@RestController
@RequestMapping("/brand/goodsgallery")
public class BrandGoodsGalleryController {
    @Autowired
    private BrandGoodsGalleryService goodsGalleryService;

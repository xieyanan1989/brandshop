 ...
 */
@RestController
@RequestMapping("/brand/sys/role")
public class BrandSysRoleController extends BrandAbstractController {
    @Autowired
    private BrandSysRoleService sysRoleService;
    @Autowired
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<BrandSysRoleEntity> list = sysRoleService.queryList(query);
    ...
    public R select() {
        ...
        List<BrandSysRoleEntity> list = sysRoleService.queryList(map);
    ...
    public R info(@PathVariable("roleId") Long roleId) {
        BrandSysRoleEntity role = sysRoleService.queryObject(roleId);
    ...
    public R save(@RequestBody BrandSysRoleEntity role) {
        ValidatorUtils.validateEntity(role);
        role.setBrandId(getBrandId());
    ...
    public R update(@RequestBody BrandSysRoleEntity role) {
        ValidatorUtils.validateEntity(role);
        role.setBrandId(getBrandId());
        role.setCreateUserId(getUserId());

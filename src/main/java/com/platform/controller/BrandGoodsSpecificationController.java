 ...
 */
@RestController
@RequestMapping("/brand/goodsspecification")
public class BrandGoodsSpecificationController extends BrandAbstractController{
    @Autowired
    private BrandGoodsSpecificationService goodsSpecificationService;
